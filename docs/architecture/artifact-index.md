...
| ADR-013 | [Reporter completes the check run last](decisions/ADR-013-reporter-completes-check-run-last.md) | adr | target | accepted (amended by ADR-019, ADR-020) | platform-team | 2026-09-15 | "Reporting pending" alerts recur |

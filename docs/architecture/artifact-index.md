...
| ADR-002 | [Merge-queue gate](decisions/ADR-002-merge-queue-gate.md) | adr | target | accepted (amended by ADR-008; ADR-014 proposed) | platform-team | 2026-09-15 | Native pause ships |
| ADR-003 | [State in GitHub](decisions/ADR-003-state-in-github.md) | adr | target | accepted (ADR-013 proposed) | platform-team | 2026-09-15 | Walk-back above 50 calls |
...
| ADR-010 | [Self-hosted trigger worker](decisions/ADR-010-self-hosted-trigger-worker.md) | adr | target | accepted (amended by ADR-012; ADR-013, ADR-014 proposed) | platform-team | 2026-09-15 | Webhook hosting available |
...
| ADR-015 | [Reconcile through closure](decisions/ADR-015-reconcile-through-closure.md) | adr | target | proposed | platform-team | 2026-09-15 | Closed lock left unreconciled |
...
CQ-1 to CQ-9 are settled. CQ-10 to CQ-12 came from an adversarial review of the
architecture on 2026-09-15 and await the requester:

- **CQ-10 (ADR-013):** replay interrupted reports; alert after 15 min.
- **CQ-11 (ADR-014):** a 4 h lock lease; `mw-observer` gains Issues: read.
- **CQ-12 (ADR-015):** reconcile through closure; 30-day lookback.

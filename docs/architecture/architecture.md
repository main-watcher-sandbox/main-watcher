...
sources: [FR-1, FR-2, FR-3, FR-4, FR-5, FR-6, C-1, C-2, C-6, C-7, ADR-001, ADR-002, ADR-003, ADR-004, ADR-007, ADR-008, ADR-009, ADR-010, ADR-011, ADR-012, ADR-013, ADR-014, ADR-015, ADR-016, ADR-017, ADR-018, ADR-019]
confidence: assumed
---
...
| ADR-013 | The Reporter completes the check run last; an interrupted report is replayed | Accepted (CQ-10), amended by ADR-019 | "Reporting pending" alert more than once a month |
